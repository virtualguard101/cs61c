...
map:
    ...
    # THINK: why a0? As an argument passed into function
    lw a0, 0(s0)

    # Call the function in question on that value. DO NOT use a label (be prepared to answer why).
    # What function? Recall the second parameters of "map"
    jalr ra, s1, 0

    # store the returned value back into the node
    # Where can you assume the returned value is? We use a0/a1 sa return value. And it's a convention
    sw a0, 0(s0)
